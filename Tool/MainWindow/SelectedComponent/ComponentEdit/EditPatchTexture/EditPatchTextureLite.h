...
public:
	...
	EditPatchTextureLite(PatchTextureLite* patchTexL, UICommandList* cmdList) noexcept;
...
public:
	...
	EditPatchTextureLite1(PatchTextureLite1* patchTex1L, UICommandList* cmdList) noexcept;
};
...
public:
	...
	EditPatchTextureLite3(PatchTextureLite3* patchTex3L, UICommandList* cmdList) noexcept;
...
public:
	...
	EditPatchTextureLite9(PatchTextureLite9* patchTexL9, UICommandList* cmdList) noexcept;
